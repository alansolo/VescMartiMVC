...
namespace VESCServices.Framework
{
    /// <summary>
    /// Administra el log 
    /// </summary>
    public class Log
    {
        ...
        public static void WriteException(string codigo, string user, Exception exception)
        {
            try
            {
                string error = string.Format("{0} :: {1} :: {2} :: {3} :: {4}", DateTime.Now, user, codigo, exception.Message, exception.StackTrace);
