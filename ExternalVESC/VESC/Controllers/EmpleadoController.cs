...
namespace VESC.Controllers
{
    public class EmpleadoController : Controller
    {
        ...
        public JsonResult GetEmpleado()
        {
            ...
            int idRazonSocial = int.Parse(Session["IdRazonSocial"].ToString());
            ...
            filtroEmpleado.EmpleadoPadreID = null;
            ...
            listaEmpleadosActual = (from empleado in listaEmpleados
                                    ...
                                    where empleado.idEmpleadoPadre == 0 || empleado.idEmpleadoPadre == null
        ...
        public JsonResult AddEmpleado(ServiceReference.EmpleadoDTO empleado, List<ServiceReference.EmpleadoDTO> listaEmpleado)
        {
            bool boolSession = true;
            bool boolError = false;
            string strError = string.Empty;
        ...
        public JsonResult EditEmpleado(ServiceReference.EmpleadoDTO empleado, List<ServiceReference.EmpleadoDTO> listaEmpleado)
        {
            bool boolSession = true;
            bool boolError = false;
            string strError = string.Empty;
